...
<head>
    ...
    <style>
        ...
        /* Left Side */
        .auth-form-side { flex: 1; padding: 0 100px; background: white; display: flex; flex-direction: column; justify-content: center; }
        .logo-area { text-align: center; margin-bottom: 30px; }
        .logo-area i { font-size: 40px; color: var(--primary); margin-bottom: 10px; }
        
        /* Role Switcher */
        .role-switch { display: flex; background: #f0f2f5; padding: 4px; border-radius: 8px; margin-bottom: 25px; }
        
        /* Quan trọng: Thêm transition để hiệu ứng chuyển mượt hơn */
        .role-switch button { 
            flex: 1; padding: 10px; border: none; background: transparent; 
            cursor: pointer; border-radius: 6px; font-weight: 600; color: #666; 
            transition: all 0.3s ease;
        }
        
        /* Class active sẽ được JavaScript thêm vào khi bấm */
        ...
        .form-group input { width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 8px; box-sizing: border-box; outline: none; transition: 0.3s; }
        .form-group input:focus { border-color: var(--primary); }
        
        .options { display: flex; justify-content: space-between; font-size: 13px; margin-bottom: 25px; color: #555; }
        .options a { color: var(--primary); text-decoration: none; }
        
        .btn-submit { width: 100%; padding: 12px; background: var(--primary); color: white; border: none; border-radius: 8px; font-weight: bold; cursor: pointer; font-size: 16px; }
        ...
        /* Right Side (Banner) */
        .auth-banner-side { flex: 1; background: linear-gradient(135deg, #e0f2ff 0%, #ffffff 100%); display: flex; align-items: center; justify-content: center; text-align: center; padding: 50px; }
        .banner-content img { width: 100%; max-width: 400px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); margin-bottom: 20px; }
        .banner-content h3 { color: #333; margin-bottom: 10px; }
        .banner-content p { color: #666; line-height: 1.5; }
    </style>
</head>
<body>
    <div class="container">
        <div class="auth-form-side">
            ...
            <form action="login" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone" placeholder="Nhập email hoặc số điện thoại" required>
                </div>
                <div class="form-group">
