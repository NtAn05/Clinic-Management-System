...
<html>
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/pages/profile/historyOfAppointment/reportDoctor.css">
    ...
    <body>
        ...
        <div class="page">
            <div class="content">
                <div class="main">
                    <form method="post" action="${pageContext.request.contextPath}/reportdoctorservlet">
